...
if (!db) {
  ...
  officers: [
    ...
    {
      id: 'officer-1-sanitation',
      name: 'Sanitation Officer One',
      username: 'officer1.sanitation',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-sanitation',
    ...
    {
      id: 'officer-2-sanitation',
      name: 'Sanitation Officer Two',
      username: 'officer2.sanitation',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-sanitation',
    ...
    {
      id: 'officer-1-roads',
      name: 'Roads Officer One',
      username: 'officer1.roads',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-roads',
    ...
    {
      id: 'officer-2-roads',
      name: 'Roads Officer Two',
      username: 'officer2.roads',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-roads',
    ...
    {
      id: 'officer-1-water',
      name: 'Water Officer One',
      username: 'officer1.water',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-water',
    ...
    {
      id: 'officer-2-water',
      name: 'Water Officer Two',
      username: 'officer2.water',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-water',
    ...
    {
      id: 'officer-1-electricity',
      name: 'Electricity Officer One',
      username: 'officer1.electricity',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-electricity',
    ...
    {
      id: 'officer-2-electricity',
      name: 'Electricity Officer Two',
      username: 'officer2.electricity',
      passwordHash: defaultHash,
      role: 'OFFICER',
      status: 'ACTIVE',
      departmentId: 'dept-electricity',
